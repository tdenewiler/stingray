...
int buttons_gains( GtkWidget *box )
{
	...
	g_signal_connect( button_get_gain,
	                  "clicked",
	                  G_CALLBACK( events_gain_get ),
	                  NULL
	                );
	g_signal_connect( button_set_gain,
	                  "clicked",
	                  G_CALLBACK( events_gain_set ),
	                  NULL
	                );
